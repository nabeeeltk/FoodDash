...
class TrackOrderPage extends StatelessWidget {
  ...
  TrackOrderPage({super.key, required this.orderId, required this.orderStatus});
  @override
  ...
  Widget buildTimelineTile(String title, String date,
      {required bool isDeliveryStep}) {
    return TimelineTile(
      ...
      afterLineStyle:
          LineStyle(color: isDeliveryStep ? Colors.blue : Colors.green),
      startChild: Padding(
